...
namespace ConsentManager.ConsentManagerDemo.Scripts
{
    ...
    public class AppodealADS : MonoBehaviour, IAppodealInitializationListener, IInAppPurchaseValidationListener,
                                ...
                                IConsentFormListener, IConsentInfoUpdateListener, IAdRevenueListener
    {
...
#elif UNITY_ANDROID
        public static string appKey = "3a98a8e06267b07d511879a6cbe338351e2017ee89712279";
#elif UNITY_IPHONE
        public static string appKey = "3a98a8e06267b07d511879a6cbe338351e2017ee89712279";
#else
	    public static string appKey = "";
        ...
        public void InitializeBannerInMainMenu()
        {
            if (!Appodeal.isLoaded(Appodeal.BANNER))
            {
                Appodeal.cache(Appodeal.BANNER);
            }
            ShowBannerBottom(); // Или ShowBannerTop(), в зависимости от того, где вы хотите отобразить баннер
        }
